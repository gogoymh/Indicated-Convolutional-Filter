...
add_m1 = matrix(0, nrow=nrow(zero_m), ncol=((2*Wt+k)-ncol(zero_m)))
add_m2 = matrix(0, nrow=((2*Ht+k)-nrow(zero_m)), ncol=ncol(zero_m))
add_m3 = matrix(0, nrow=((2*Ht+k)-nrow(zero_m)), ncol=((2*Wt+k)-ncol(zero_m)))
